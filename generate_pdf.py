...
def markdown_to_html(md_file):
    ...
    <body>
        {html_content}
        <div class="footer">
            <p>Generated from Markdown on 2026-05-06 | FH Technikum Wien Security Lab Protocol Project © [Mosudi I. O.](https://github.com/imosudi/suricata-ips-sbc-gateway)</p>
        </div>
    </body>
    </html>
    """
